  ...
  (function () {
    with (FBL) {
      ...
      var attributeList = domplate({
        ...
        attributeDiff:
          SPAN({
            class: "nodeAttr", $removedClass: "$attr|isAttrRemoved", $addedClass: "$attr|isAttrAdded",
      ...
      var allChanges = {
        ...
        DocType: domplate(ChangeElement, {
          tag: DIV({
            class: "nodeBox emptyNodeBox repIgnore", _repObject: "$change",
            $removedClass: "$change|isElementRemoved", $addedClass: "$change|isElementAdded",
        ...
        Element: domplate(ChangeElement, {
          tag:
            DIV({
              class: "nodeBox containerNodeBox repIgnore", _repObject: "$change",
              $removedClass: "$change|isElementRemoved", $addedClass: "$change|isElementAdded",
              $firebugDiff: "$change|isFirebugDiff", $appDiff: "$change|isAppDiff"
            },
        ...
        TextElement: domplate(ParentChangeElement, {
          tag:
            DIV({
              class: "nodeBox textNodeBox open repIgnore", _repObject: "$change",
              $removedClass: "$change|isElementRemoved", $addedClass: "$change|isElementAdded",
              $firebugDiff: "$change|isFirebugDiff", $appDiff: "$change|isAppDiff"
            },
        ...
        TextNode: domplate(ChangeElement, {
          tag:
            DIV({
              class: "nodeBox", _repObject: "$change",
              $removedClass: "$change|isElementRemoved", $addedClass: "$change|isElementAdded",
              $firebugDiff: "$change|isFirebugDiff", $appDiff: "$change|isAppDiff"
            },
